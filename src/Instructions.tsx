      ...
      <div className="flex flex-col gap-4">
        ...
        <div>
          ...
          <textarea
            ...
            value={code}
            rows={5}
            className="w-full p-3 border border-slate-200 rounded-md text-sm font-mono"
          />
        </div>
